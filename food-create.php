...
$sql = "INSERT INTO tbl_food (fldfoodName, fldfoodBrand, fldfoodAmount, fld foodFrequency, fldfoodFavorite, fldfoodNotes) VALUES ('$txtfoodName','$txtfoodBrand','$txtfoodAmount','$txtfoodFrequency','$txtfoodFavorite','$txtfoodNotes')";
echo $sql;
// insert in database 
