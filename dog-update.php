<?php
  ...
  $sql = "update tbl_dog set flddogName='$txtdogName', flddogDOB='$txtdogDOB', flddogBreed= '$txtdogBreed', flddogSex= '$txtdogSex', flddogWeightInPounds= '$txtdogWeightInPounds', flddogSterilized= '$txtdogSterilized', flddogMicrochip= '$txtdogMicrochip', flddogNotes= '$txtdogNotes' where DogId=$DogId";
